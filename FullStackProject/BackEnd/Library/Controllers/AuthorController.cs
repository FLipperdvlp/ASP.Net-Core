...
public class AuthorController(LibraryDbContext dbContext) : ControllerBase
{
    ...
    [HttpPost]
    public ActionResult<Author> CreateAuthor([FromBody] CreateAuthorRequestModel model)
    {
    ...
    public ActionResult<Author> UpdateAuthor(int authorId, [FromBody] UpdateAuthorRequestModel model)
    {
        var author = dbContext.Authors.Find(authorId);
        if (author is null)
    ...
    public ActionResult<Author> DeleteAuthor(int authorId)
    {
    ...
    public ActionResult<Author> GetAuthorBooks(int authorId)
    {
        var author = dbContext.Authors.Include((a => a.Books)).FirstOrDefault(a => a.Id == authorId);
